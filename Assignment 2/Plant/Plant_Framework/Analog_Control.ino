...
/// readLDRPercent() -> Reads the value from the ldr and returns it as a percentage
/// readLDRPercentS() -> Reads the value from the ldr as a percentage and prints it as a string with % appended
/// readSoilMoisture() -> Reads the value from the soilmoisture sensor and returns it
/// readSoilMoisturePercent() -> Reads the soil moisture and stores and returns it as a percentage
/// readSoilMoisturePercentS() -> Returns the last read soil moisture percentage as a string with % appended, reading the value if it isn't defined yet
///
